...
export function WorkflowView({ root, runtimeContext, onDirtyChange, onToast }: WorkflowViewProps): JSX.Element {
  const { t } = useT()
    ...
    <>
      <TwoColumns
        ...
        detail={editor.selectedStep
          ? <StageEditorPane key={`${editor.wfName} ${editor.selectedStep.id}`} editor={editor} step={editor.selectedStep} runtimeContext={runtimeContext} />
