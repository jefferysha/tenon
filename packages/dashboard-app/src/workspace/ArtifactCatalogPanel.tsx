...
function metadata(v: ArtifactVersion): string {
  const parts = [v.quality, `${v.size} B`, v.consumed ? 'consumed' : undefined, v.affected ? 'affected' : undefined, v.availableFromStage ? `from ${v.availableFromStage}` : undefined]
