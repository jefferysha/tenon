...
export interface ArtifactCatalog { readonly revision: number; readonly digest: string; readonly stageAttemptId: string; readonly entries: readonly ArtifactCatalogEntry[]; readonly history?: readonly ArtifactCatalogEntry[] }
...
export interface ArtifactPolicy { readonly dependencyStages?: readonly string[]; readonly includeCandidates?: boolean; readonly includeHistory?: boolean; readonly requireQuality?: ArtifactQuality; readonly maxEntries?: number }
